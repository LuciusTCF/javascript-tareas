...
//forEach
alumnos.forEach((alumno) => console.log(`Hola, soy ${alumno.toUpperCase()}`));
...
alumnos.map((alumno) => {
    return console.log(`Hola, soy ${alumno.toUpperCase()}`);
});
...
let personas = [
    "Joaquín", "Daniel", "Magdalena", "Gonzalo", "Armando", "Samuel", "Valentina"];

const obtenerNombrePorLetra = (letra) => {
